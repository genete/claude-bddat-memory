...
metadata: 
  ...
  modified: 2026-08-29T07:45:05.565Z
---
...
Detalle de diseño confirmado: el sujeto ESFTT (`'Distribucion/AAP/RESOLUCION'`) **no tiene segmento de tarea** → las tareas se rigen por el patrón FTT (`tramites_tareas`), no por reglas normativas del motor. Coherente con el diseño del dominio.
